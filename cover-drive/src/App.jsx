...
import CoverDriveGame from './CoverDriveGame.jsx';
...
export default function App() {
  ...
  // The stats contract is {runs, boundaries, wickets, perfects} — there is no
  // `score` key. Runs are what the CRM records for this game.
  const leadScore = stats.runs ?? 0;
