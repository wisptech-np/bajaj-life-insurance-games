...
// Copied from the gold-standard bubble shooter; logic identical, copy retitled for Shield Drop.
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const result = await submitToLMS({
        ...
        email: email.trim(),
        score,
        summaryDtls: 'Shield Drop - Post Game Lead',
      });
