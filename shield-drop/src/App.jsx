...
// Mirrors the gold-standard life-goals-bubble-shooter screen flow exactly.
import React, { useCallback, useState } from 'react';
import { incrementPlayCount } from './services/playCount';
import ShieldDrop from './ShieldDrop.jsx';
...
import { unlockAudio, sfxTap } from './audio.js';
  ...
  return (
    <div
      style={{
        ...
        overflow: 'hidden',
        background:
          'radial-gradient(ellipse at 50% 25%, rgba(14, 79, 148, 0.55), rgba(5, 26, 58, 0.9) 72%), #051a3a',
      }}
    >
      ...
      {screen === 'game' && (
        <ShieldDrop key={gameKey} config={GAME_CONFIG} onWin={handleWin} onLose={handleLose} />
      )}
