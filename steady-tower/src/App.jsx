...
import SteadyTowerGame from './SteadyTowerGame.jsx';
...
const THEME = {
  homeBg: 'linear-gradient(180deg, #0B1221 0%, #0E2A55 55%, #061634 100%)',
  gameBg: 'linear-gradient(180deg, #061024 0%, #0B1F42 60%, #0B1221 100%)',
};
