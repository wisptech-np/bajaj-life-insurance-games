...
// Copied from the life-goals-bubble-shooter gold standard; copy for Guardian Arena (attribution string only).
...
export default function SlotBookingModal({ initialName, initialMobile, score, onConfirmed }) {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const remarks = `Guardian Arena Slot Booking | Score: ${score ?? 0}`;
      if (leadNo) {
