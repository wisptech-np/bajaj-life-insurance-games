...
// Copied from the life-goals-bubble-shooter gold standard; copy for Guardian Arena
// (guardian-shelter's background PNG swapped for a pure gradient — no image asset here).
...
export default function ThankYouScreen({ details, onPlayAgain }) {
  ...
  return (
    <div className="sl-thanks-container" style={{
      background: 'linear-gradient(180deg, #0B1221 0%, #071a3d 55%, #020617 100%)',
    }}>
