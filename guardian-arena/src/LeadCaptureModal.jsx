...
// Copied from the life-goals-bubble-shooter gold standard; copy adapted for Guardian Arena (title/summary text only).
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const result = await submitToLMS({
        ...
        mobile,
        score,
        summaryDtls: 'Guardian Arena - Post Game Lead',
      });
