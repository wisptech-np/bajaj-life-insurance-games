...
// Copied from the life-goals-bubble-shooter gold standard; copy restyled for Wealth Carrom.
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const result = await submitToLMS({
        ...
        mobile,
        score,
        summaryDtls: 'Wealth Carrom - Post Game Lead',
      });
