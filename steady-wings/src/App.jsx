...
import SteadyWingsGame from './SteadyWingsGame.jsx';
...
const THEME = {
  homeBg: 'radial-gradient(ellipse at 50% 26%, rgba(59,141,212,0.42), rgba(5,26,58,0.96) 72%), #051A3A',
  gameBg: 'linear-gradient(180deg, #051A3A 0%, #0E4F94 58%, #062042 100%)',
};
...
export default function App() {
  ...
  return (
    <div style={{
      ...
      margin: '0 auto',
      overflow: 'hidden',
      background: 'linear-gradient(180deg, #051A3A 0%, #0E4F94 58%, #062042 100%)',
    }}>
      {screen === 'home' && (
      ...
      {screen === 'results' && (
        <ResultsScreen
          ...
          retryLabel={won ? 'Fly again' : 'Try again'}
        />
      )}
