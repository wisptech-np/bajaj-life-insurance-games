...
// Copied from the life-goals-bubble-shooter gold standard; copy restyled for Goal Juggler.
import React from 'react';

// Backdrop is a floodlit-stadium wash built from gradients rather than the
// photograph the scaffold shipped with: no binary asset to carry, and it stays
// crisp at any density. Brand blue overhead, pitch green along the bottom.
const STADIUM_BG = [
  'radial-gradient(ellipse 120% 60% at 50% 0%, rgba(30,107,224,0.30), rgba(2,6,23,0) 70%)',
  'radial-gradient(ellipse 140% 45% at 50% 100%, rgba(18,97,58,0.42), rgba(2,6,23,0) 72%)',
