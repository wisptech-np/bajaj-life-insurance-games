...
import RiskSlashGame from './RiskSlashGame.jsx';
...
const THEME = {
  homeBg: 'linear-gradient(180deg, #071026 0%, #0d1e3f 55%, #0a1730 100%)',
  gameBg: 'linear-gradient(180deg, #071026 0%, #0d1e3f 55%, #0a1730 100%)',
};
