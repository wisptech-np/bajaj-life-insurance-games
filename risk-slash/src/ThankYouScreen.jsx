...
// Copied from the guardian-shelter gold standard; the PNG backdrop is replaced
// with a gradient so Risk Slash ships with zero binary assets.
...
export default function ThankYouScreen({ details, onPlayAgain }) {
  ...
  return (
    <div className="sl-thanks-container" style={{
      background: 'radial-gradient(ellipse at 50% 20%, rgba(30, 107, 224, 0.30), rgba(7, 16, 38, 0.9) 65%), linear-gradient(180deg, #071026 0%, #0d1e3f 55%, #0a1730 100%)',
    }}>
