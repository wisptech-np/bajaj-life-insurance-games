...
// Copied from the guardian-shelter gold standard; copy restyled for Premium Tiles.
import React from 'react';

// Backdrop is a concert-hall wash built from gradients rather than the
// photograph the scaffold shipped with: no binary asset to carry, and it stays
// crisp at any density. Brand blue overhead, a warm stage glow at the bottom.
const STAGE_BG = [
  'radial-gradient(ellipse 120% 60% at 50% 0%, rgba(30,107,224,0.30), rgba(2,6,23,0) 70%)',
  'radial-gradient(ellipse 140% 45% at 50% 100%, rgba(242,101,34,0.22), rgba(2,6,23,0) 72%)',
...
export default function ThankYouScreen({ details, onPlayAgain }) {
  ...
  return (
    <div className="sl-thanks-container" style={{ background: STAGE_BG }}>
