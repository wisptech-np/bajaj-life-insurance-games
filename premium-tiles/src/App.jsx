...
import PremiumTilesGame from './PremiumTilesGame.jsx';
...
const THEME = {
  homeBg: 'linear-gradient(180deg, #081530 0%, #0B2450 55%, #06122B 100%)',
  gameBg: 'linear-gradient(180deg, #081530 0%, #0B2450 55%, #06122B 100%)',
};
