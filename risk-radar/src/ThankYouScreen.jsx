...
// Copied from the guardian-shelter gold standard; PNG backdrop replaced with a
// gradient wash (goal-juggler precedent) so Risk Radar ships zero binary assets.
...
export default function ThankYouScreen({ details, onPlayAgain }) {
  ...
  return (
    <div className="sl-thanks-container" style={{
      background:
        'radial-gradient(ellipse at 50% 18%, rgba(30, 107, 224, 0.35), rgba(2, 6, 23, 0) 60%), ' +
        'linear-gradient(180deg, #0B1221 0%, #071a38 55%, #020617 100%)',
    }}>
