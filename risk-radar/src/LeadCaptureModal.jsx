...
// Copied from the guardian-shelter gold standard; title/summary text localised for Risk Radar.
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const result = await submitToLMS({
        ...
        mobile,
        score,
        summaryDtls: 'Risk Radar - Post Game Lead',
      });
