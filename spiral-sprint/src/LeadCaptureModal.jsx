...
// Copied from the life-goals-bubble-shooter gold standard; copy restyled for Spiral Sprint.
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const result = await submitToLMS({
        ...
        email: email.trim(),
        score,
        summaryDtls: 'Spiral Sprint - Post Game Lead',
      });
