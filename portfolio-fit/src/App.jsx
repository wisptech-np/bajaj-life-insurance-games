...
import PortfolioFitGame from './PortfolioFitGame.jsx';
...
const THEME = {
  homeBg: 'radial-gradient(ellipse at 50% 24%, rgba(16, 55, 110, 0.6), rgba(11, 18, 33, 0.9) 70%), #0B1221',
  gameBg: 'radial-gradient(ellipse at 50% 18%, rgba(16, 55, 110, 0.65), rgba(11, 18, 33, 0.92) 72%), #0B1221',
};
