...
// Copied from the gold standard (life-goals-bubble-shooter); logic identical,
// remarks copy adjusted for Risk Exit.
...
export default function SlotBookingModal({ initialName, initialMobile, score, onConfirmed }) {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const remarks = `Risk Exit Slot Booking | Score: ${score ?? 0}`;
      if (leadNo) {
