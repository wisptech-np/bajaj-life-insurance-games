...
// Copied from the life-goals-bubble-shooter gold standard; copy restyled for Life Rush.
import React from 'react';

// Backdrop is the game's own "rush" wash built from gradients rather than the
// photograph the scaffold shipped with: no binary asset to carry, and it stays
// crisp at any density. Orange streak overhead (the rush), brand blue below.
const STADIUM_BG = [
  'radial-gradient(ellipse 130% 55% at 50% 0%, rgba(242,101,34,0.28), rgba(2,6,23,0) 68%)',
  'radial-gradient(ellipse 140% 50% at 50% 100%, rgba(30,107,224,0.34), rgba(2,6,23,0) 72%)',
  'linear-gradient(180deg, rgba(2,6,23,0.55), rgba(2,6,23,0.9))',
  'linear-gradient(180deg, #0B1221 0%, #0A1E42 48%, #061229 100%)',
].join(', ');
...
export default function ThankYouScreen({ details, onPlayAgain }) {
  ...
  return (
    <div className="sl-thanks-container" style={{ background: STADIUM_BG }}>
