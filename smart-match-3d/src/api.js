...
export async function submitToLMS({ name, mobile, email, score, summaryDtls = 'Smart Match 3D Lead' }) {
...
export async function updateLeadNew(leadNo, { name, mobile, date, time, remarks }) {
  ...
  const payload = {
    ...
    miscObj1: {
      ...
      stringval5: time || '',
      stringval6: remarks || 'Slot Booking via Smart Match 3D',
...
export const LEAD_NO_KEY = 'smartMatch3dLeadNo';
