...
// Copied from the guardian-shelter gold standard; copy restyled for SIP Stack.
// Backdrop is a gradient wash instead of the photograph the scaffold shipped
// with: no binary asset to carry, and it stays crisp at any pixel density.
import React from 'react';

const TOWER_BG = [
  'radial-gradient(ellipse 130% 55% at 50% 0%, rgba(30,107,224,0.28), rgba(2,6,23,0) 70%)',
  'radial-gradient(ellipse 120% 40% at 50% 100%, rgba(242,101,34,0.20), rgba(2,6,23,0) 72%)',
  'linear-gradient(180deg, rgba(2,6,23,0.55), rgba(2,6,23,0.9))',
  'linear-gradient(180deg, #0B1221 0%, #0E2247 55%, #081226 100%)',
].join(', ');
...
export default function ThankYouScreen({ details, onPlayAgain }) {
  ...
  return (
    <div className="sl-thanks-container" style={{ background: TOWER_BG }}>
