...
// Screen flow copied from the guardian-shelter gold standard.
import { incrementPlayCount } from './services/playCount';
import React, { useCallback, useState } from 'react';
import SipStackGame from './SipStackGame.jsx';
...
const THEME = {
  homeBg: 'linear-gradient(180deg, #0B1221 0%, #0E2247 55%, #081226 100%)',
  gameBg: 'linear-gradient(180deg, #0B1221 0%, #0E2247 60%, #0B1221 100%)',
};
...
export default function App() {
  ...
  // Instant restart: one tap, no interstitial. The gameKey remount gives a
