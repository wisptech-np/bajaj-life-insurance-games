...
// Copied from the guardian-shelter gold standard; copy restyled for Legacy Echo.
import React from 'react';

// Backdrop is a time-vault wash built from gradients rather than the photograph
// the scaffold shipped with (goal-juggler precedent): no binary asset to carry,
// and it stays crisp at any density. Brand blue overhead, an echo-violet ring
// glow mid-frame, deep navy below.
const ECHO_BG = [
  'radial-gradient(ellipse 120% 55% at 50% 0%, rgba(30,107,224,0.32), rgba(2,6,23,0) 70%)',
  'radial-gradient(circle 180px at 50% 46%, rgba(139,109,255,0.22), rgba(2,6,23,0) 75%)',
  'radial-gradient(ellipse 140% 45% at 50% 100%, rgba(242,101,34,0.16), rgba(2,6,23,0) 72%)',
  'linear-gradient(180deg, rgba(2,6,23,0.55), rgba(2,6,23,0.9))',
  'linear-gradient(180deg, #0A1A38 0%, #101B3F 45%, #070E22 100%)',
].join(', ');
...
export default function ThankYouScreen({ details, onPlayAgain }) {
  ...
  return (
    <div className="sl-thanks-container" style={{ background: ECHO_BG }}>
