...
import PremiumPulseGame from './PremiumPulseGame.jsx';
...
// Only the game backdrop is set from here; the screens own their own
// backgrounds (see SCREEN_BG in Screens.jsx), so there is no theme prop.
const THEME = {
  gameBg: 'linear-gradient(180deg, #051a3a 0%, #0a2c5c 55%, #03102a 100%)',
};
