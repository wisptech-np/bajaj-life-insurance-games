...
// Copied from the guardian-shelter scaffold; copy restyled for Premium Pulse.
import React from 'react';

// Backdrop is a concentric "pulse" wash built from gradients rather than the
// photograph the scaffold shipped with: no binary asset to carry, and it stays
// crisp at any density. Brand blue rings radiating out of the centre, warm
// orange lift at the base.
const PULSE_BG = [
  'radial-gradient(circle 220px at 50% 34%, rgba(59,141,212,0.30), rgba(2,6,23,0) 70%)',
  'radial-gradient(circle 420px at 50% 34%, rgba(0,91,172,0.22), rgba(2,6,23,0) 72%)',
  'radial-gradient(ellipse 140% 45% at 50% 100%, rgba(242,105,34,0.20), rgba(2,6,23,0) 70%)',
  'linear-gradient(180deg, #051a3a 0%, #071f45 45%, #030c1d 100%)',
].join(', ');
...
export default function ThankYouScreen({ details, onPlayAgain }) {
  ...
  return (
    <div className="sl-thanks-container" style={{ background: PULSE_BG }}>
