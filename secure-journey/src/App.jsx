...
// Mirrors the gold-standard life-goals-bubble-shooter screen flow.
import { incrementPlayCount } from './services/playCount';
import React, { useCallback, useState } from 'react';
import SecureJourney from './SecureJourney.jsx';
...
const THEME = {
  homeBg: 'radial-gradient(ellipse at 50% 24%, rgba(20, 97, 168, 0.5), rgba(4, 16, 31, 0.92) 70%), #04101f',
  gameBg: '#04101f',
};
