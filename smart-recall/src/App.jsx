// App.jsx — Home → How to play → Game → Results (+Lead) → [Slot] → ThankYou
import { incrementPlayCount } from './services/playCount';
import React, { useCallback, useState } from 'react';
import SmartRecallGame from './SmartRecallGame.jsx';
...
const THEME = {
  homeBg: 'radial-gradient(ellipse at 50% 26%, rgba(14,79,148,0.55), rgba(11,18,33,0.96) 72%), #0B1221',
