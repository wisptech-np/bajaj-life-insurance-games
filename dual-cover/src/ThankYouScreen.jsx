...
// Copied from the life-goals-bubble-shooter gold standard; copy restyled for Dual Cover.
import React from 'react';

// Backdrop is a twin-glow wash built from gradients rather than the photograph
// the scaffold shipped with: no binary asset to carry, and it stays crisp at
// any density. Protection blue on one shoulder, growth orange on the other.
const DUAL_BG = [
  'radial-gradient(ellipse 90% 55% at 18% 8%, rgba(30,107,224,0.32), rgba(2,6,23,0) 70%)',
  'radial-gradient(ellipse 90% 55% at 82% 8%, rgba(242,101,34,0.26), rgba(2,6,23,0) 70%)',
  'radial-gradient(ellipse 140% 45% at 50% 100%, rgba(10,36,80,0.5), rgba(2,6,23,0) 72%)',
  'linear-gradient(180deg, #0B1221 0%, #0A1B3E 45%, #060E22 100%)',
].join(', ');
...
export default function ThankYouScreen({ details, onPlayAgain }) {
  ...
  return (
    <div className="sl-thanks-container" style={{ background: DUAL_BG }}>
