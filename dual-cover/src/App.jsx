...
import DualCoverGame from './DualCoverGame.jsx';
...
const THEME = {
  homeBg: 'linear-gradient(180deg, #08122B 0%, #0D2350 55%, #060E22 100%)',
  gameBg: 'linear-gradient(180deg, #08122B 0%, #0D2350 55%, #060E22 100%)',
};
...
export default function App() {
  ...
  const [assist, setAssist] = useState(false);      // accessibility: direct-drag rotation
  ...
  return (
    <div style={{
      ...
      {screen === 'howtoplay' && (
        <HowToPlayScreen onPlay={startGame} assist={assist} onToggleAssist={setAssist} />
      )}
