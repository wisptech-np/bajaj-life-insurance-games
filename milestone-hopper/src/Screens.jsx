...
// Placeholder screens copied from guardian-shelter; real art/polish lands in Task 4.
    ...
    >
      ...
      <div style={{ textAlign: 'center', zIndex: 2 }}>
        ...
        <p style={{
          ...
          Navigate life's risks. Reach every milestone.
        </p>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            ...
            <span>Tap to hop forward</span>
          </div>
          <div style={{ display: 'flex', gap: 10 }}>
            <span style={{ color: '#FF8A3D', fontWeight: 900 }}>2.</span>
            <span>Swipe to dodge</span>
          </div>
          <div style={{ display: 'flex', gap: 10 }}>
            <span style={{ color: '#FF8A3D', fontWeight: 900 }}>3.</span>
            <span>Reach Retirement before time runs out</span>
          </div>
        </div>
