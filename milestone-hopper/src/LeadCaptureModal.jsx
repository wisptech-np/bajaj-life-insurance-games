...
// Copied from the life-goals-bubble-shooter gold standard; copy restyled for Milestone Hopper.
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const result = await submitToLMS({
        ...
        mobile,
        score,
        summaryDtls: 'Milestone Hopper - Post Game Lead',
      });
