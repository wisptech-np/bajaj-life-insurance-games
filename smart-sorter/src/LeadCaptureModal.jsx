...
// Copied from the life-goals-bubble-shooter gold standard; copy restyled for Smart Sorter.
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const result = await submitToLMS({
        ...
        mobile,
        score,
        summaryDtls: 'Smart Sorter - Post Game Lead',
      });
